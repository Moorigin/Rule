...
```
  AI:
    type: http
    behavior: classical
    url: https://cdn.jsdelivr.net/gh/Moorigin/Rule@main/Clash/AI.yaml
    path: ./Rules/AI.yaml
    interval: 86400
```
...
### Surge
```
https://cdn.jsdelivr.net/gh/Moorigin/Rule@main/Surge/Apple.list
```
...
### Surge
```
https://cdn.jsdelivr.net/gh/Moorigin/Rule@main/Surge/iCloud.list
```
...
### Surge
```
https://cdn.jsdelivr.net/gh/Moorigin/Rule@main/Surge/AsiaMedia.list
```
